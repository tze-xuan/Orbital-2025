      ...
      <Box bg="#FEF1C5" shadow="sm" borderBottomWidth="1px">
        <Container maxW="md" py={12}>
          <Flex align="center" justify="space-between" >
            ...
            <Badge colorScheme="orange" px={3} py={1} borderRadius="full" display="flex" alignItems="center">
                ...
                {loading ? (
                  ...
                  <Center py={8} w="full">
                    <VStack spacing={4}>
                      ...
                      <Text color="gray.500" fontSize="sm">Check back later for new cafés</Text>
                      <Button 
                        colorScheme="orange" 
                        variant="outline" 
                        size="sm"
                ...
                {userStamps.length === 0 ? (
                  <Center py={8} w="full">
                    <VStack spacing={4}>
                      ...
                      <Text color="gray.500" fontSize="sm">Visit cafes to start collecting!</Text>
                    </VStack>
                  </Center>
                ) : (
                  <VStack w="full" spacing={0}>
